<?php
/**
 * landingpage functions and definitions
 *
...
function landingpage_setup() {
	/*
		...
		* If you're building a theme based on landingpage, use a find and replace
	...
	add_theme_support(
		'custom-background',
		apply_filters(
			'landingpage_custom_background_args',
			array(
...
function landingpage_scripts() {
	wp_enqueue_style( 'landingpage-style', get_stylesheet_uri(), array(), _S_VERSION );
	wp_style_add_data( 'landingpage-style', 'rtl', 'replace' );

	wp_enqueue_script( 'landingpage-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );
